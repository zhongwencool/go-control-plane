...
package envoy_extensions_filters_http_jwt_authn_author_v3
...
type RemoteAcl struct {
	...
	// The HTTP URI to fetch the ACL. For example:
	//
	// .. code-block:: yaml
	//
	//    http_uri:
	...
	//
	HttpUri *v3.HttpUri `protobuf:"bytes,1,opt,name=http_uri,json=httpUri,proto3" json:"http_uri,omitempty"`
	// Duration after which the cached ACL should be expired. If not specified, default cache
	// duration is 5 minutes.
	CacheDuration *duration.Duration `protobuf:"bytes,2,opt,name=cache_duration,json=cacheDuration,proto3" json:"cache_duration,omitempty"`
}

func (x *RemoteAcl) Reset() {
	*x = RemoteAcl{}
	if protoimpl.UnsafeEnabled {
...
func (x *RemoteAcl) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemoteAcl) ProtoMessage() {}

func (x *RemoteAcl) ProtoReflect() protoreflect.Message {
	mi := &file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemoteAcl.ProtoReflect.Descriptor instead.
func (*RemoteAcl) Descriptor() ([]byte, []int) {
	return file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDescGZIP(), []int{2}
}

func (x *RemoteAcl) GetHttpUri() *v3.HttpUri {
	if x != nil {
		return x.HttpUri
	}
	return nil
...
func (x *RemoteAcl) GetCacheDuration() *duration.Duration {
	if x != nil {
		return x.CacheDuration
	}
	return nil
...
type JwtAuthentication struct {
	...
	// Types that are assignable to AclSourceSpecifier:
	//	*JwtAuthentication_RemoteAcl
	//	*JwtAuthentication_LocalAcl
	AclSourceSpecifier isJwtAuthentication_AclSourceSpecifier `protobuf_oneof:"acl_source_specifier"`
	// Configuration for an etcd service provider. If not
	// specified, acl will not update in real time.
	EtcdService *v32.EtcdServiceConfig `protobuf:"bytes,7,opt,name=etcd_service,json=etcdService,proto3" json:"etcd_service,omitempty"`
	EtcdPrefix  string                 `protobuf:"bytes,8,opt,name=etcd_prefix,json=etcdPrefix,proto3" json:"etcd_prefix,omitempty"`
}

func (x *JwtAuthentication) Reset() {
	*x = JwtAuthentication{}
	if protoimpl.UnsafeEnabled {
		mi := &file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*JwtAuthentication) Descriptor() ([]byte, []int) {
	return file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDescGZIP(), []int{10}
}
...
func (m *JwtAuthentication) GetAclSourceSpecifier() isJwtAuthentication_AclSourceSpecifier {
	if m != nil {
		return m.AclSourceSpecifier
	}
	return nil
}

func (x *JwtAuthentication) GetRemoteAcl() *RemoteAcl {
	if x, ok := x.GetAclSourceSpecifier().(*JwtAuthentication_RemoteAcl); ok {
		return x.RemoteAcl
	}
	return nil
}

func (x *JwtAuthentication) GetLocalAcl() *v3.DataSource {
	if x, ok := x.GetAclSourceSpecifier().(*JwtAuthentication_LocalAcl); ok {
		return x.LocalAcl
	}
	return nil
}

func (x *JwtAuthentication) GetEtcdService() *v32.EtcdServiceConfig {
	if x != nil {
		return x.EtcdService
	}
	return nil
}

func (x *JwtAuthentication) GetEtcdPrefix() string {
	if x != nil {
		return x.EtcdPrefix
	}
	return ""
...
type isJwtAuthentication_AclSourceSpecifier interface {
	isJwtAuthentication_AclSourceSpecifier()
}

type JwtAuthentication_RemoteAcl struct {
	// ACL can be fetched from remote server via HTTP/HTTPS. This field specifies the remote HTTP
	// URI and how the fetched ACL should be cached.
	//
	// Example:
	//
	// .. code-block:: yaml
	...
	//        seconds: 300
	//
	RemoteAcl *RemoteAcl `protobuf:"bytes,5,opt,name=remote_acl,json=remoteAcl,proto3,oneof"`
}

type JwtAuthentication_LocalAcl struct {
	// ACL is in local data source. It could be either in a local file or embedded in the
	// inline_string.
	//
	// Example: local file
	//
	...
	//
	//    local_acl:
	//      filename: /etc/envoy/acl/acl1.txt
	//
	// Example: inline_string
	//
	// .. code-block:: yaml
	...
	//      inline_string: ACADADADADA
	//
	LocalAcl *v3.DataSource `protobuf:"bytes,6,opt,name=local_acl,json=localAcl,proto3,oneof"`
}

func (*JwtAuthentication_RemoteAcl) isJwtAuthentication_AclSourceSpecifier() {}

func (*JwtAuthentication_LocalAcl) isJwtAuthentication_AclSourceSpecifier() {}
...
var file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x31, 0x65, 0x6e, 0x76, 0x6f, 0x79,
	...
	0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x2e, 0x76, 0x33, 0x1a, 0x1f, 0x65, 0x6e,
	0x76, 0x6f, 0x79, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f,
	0x76, 0x33, 0x2f, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x23, 0x65,
	...
	0x1a, 0x27, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x65,
	...
	0x74, 0x6f, 0x22, 0xd7, 0x04, 0x0a, 0x0b, 0x4a, 0x77, 0x74, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64,
	0x65, 0x72, 0x12, 0x1f, 0x0a, 0x06, 0x69, 0x73, 0x73, 0x75, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01,
	...
	,
	...
	0x6d, 0x73, 0x12, 0x34, 0x0a, 0x16, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x70, 0x61,
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x14, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x50, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x2e, 0x0a, 0x13, 0x70, 0x61, 0x79, 0x6c,
	0x6f, 0x61, 0x64, 0x5f, 0x69, 0x6e, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x6e,
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x3a, 0x44, 0x9a, 0xc5, 0x88, 0x1e, 0x3f, 0x0a,
	...
	0x74, 0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x2e, 0x76, 0x32, 0x61, 0x6c, 0x70,
	...
	0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x22, 0xcd, 0x01, 0x0a,
	...
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x3a, 0x43, 0x9a, 0xc5, 0x88, 0x1e, 0x3e, 0x0a, 0x3c,
	...
	0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x2e, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68,
	0x61, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x4a, 0x77, 0x6b, 0x73, 0x22, 0xcb, 0x01, 0x0a,
	0x09, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x41, 0x63, 0x6c, 0x12, 0x38, 0x0a, 0x08, 0x68, 0x74,
	...
	0x70, 0x55, 0x72, 0x69, 0x12, 0x40, 0x0a, 0x0e, 0x63, 0x61, 0x63, 0x68, 0x65, 0x5f, 0x64, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44,
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0d, 0x63, 0x61, 0x63, 0x68, 0x65, 0x44, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x3a, 0x42, 0x9a, 0xc5, 0x88, 0x1e, 0x3d, 0x0a, 0x3b, 0x65,
	...
	,
	...
	0x61, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x3a, 0x4e, 0x9a, 0xc5, 0x88, 0x1e, 0x49,
	0x0a, 0x47, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x66,
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x2e, 0x68, 0x74, 0x74, 0x70, 0x2e, 0x6a, 0x77, 0x74, 0x5f, 0x61,
	0x75, 0x74, 0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x2e, 0x76, 0x32, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x2e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x57, 0x69, 0x74, 0x68,
	0x41, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x22, 0x81, 0x05, 0x0a, 0x0e, 0x4a, 0x77,
	...
	,
	...
	0x73, 0x41, 0x6e, 0x79, 0x12, 0x6d, 0x0a, 0x0c, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x73,
	0x5f, 0x61, 0x6c, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x48, 0x2e, 0x65, 0x6e, 0x76,
	0x6f, 0x79, 0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x66, 0x69,
	0x6c, 0x74, 0x65, 0x72, 0x73, 0x2e, 0x68, 0x74, 0x74, 0x70, 0x2e, 0x6a, 0x77, 0x74, 0x5f, 0x61,
	0x75, 0x74, 0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x4a,
	...
	,
	...
	0x73, 0x3a, 0x4e, 0x9a, 0xc5, 0x88, 0x1e, 0x49, 0x0a, 0x47, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2e,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x2e, 0x68, 0x74,
	0x74, 0x70, 0x2e, 0x6a, 0x77, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74,
	0x68, 0x6f, 0x72, 0x2e, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x4a, 0x77, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x6e, 0x64, 0x4c, 0x69, 0x73,
	0x74, 0x22, 0xfd, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x6d, 0x65, 0x6e,
	...
	,
	...
	0x6d, 0x65, 0x12, 0x6c, 0x0a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x73, 0x18, 0x03,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x50, 0x2e, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2e, 0x65, 0x78, 0x74,
	0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x2e,
	0x68, 0x74, 0x74, 0x70, 0x2e, 0x6a, 0x77, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6e, 0x5f, 0x61,
	0x75, 0x74, 0x68, 0x6f, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x53,
	...
	0x1a, 0x7e, 0x0a, 0x0d, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72,
	...
	0x74, 0x70, 0x2e, 0x6a, 0x77, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74,
	0x68, 0x6f, 0x72, 0x2e, 0x76, 0x33, 0x2e, 0x4a, 0x77, 0x74, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72,
	...
	0x70, 0x2e, 0x6a, 0x77, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74, 0x68,
	0x6f, 0x72, 0x2e, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x75, 0x6c, 0x65, 0x22, 0x84, 0x07, 0x0a, 0x11, 0x4a,
	0x77, 0x74, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x71, 0x0a, 0x09, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20,
	...
	,
	...
	0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x2e, 0x76,
	0x33, 0x2e, 0x4a, 0x77, 0x74, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x3a, 0x4a, 0x9a, 0xc5, 0x88, 0x1e, 0x45, 0x0a,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x42, 0x1b, 0x0a, 0x14, 0x61, 0x63, 0x6c, 0x5f, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x03, 0xf8, 0x42,
	0x01, 0x42, 0x50, 0x0a, 0x3f, 0x69, 0x6f, 0x2e, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x70, 0x72, 0x6f,
	...
	0x2e, 0x6a, 0x77, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6e, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x6f,
	0x72, 0x2e, 0x76, 0x33, 0x42, 0x0b, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x50, 0x72, 0x6f, 0x74,
...
var file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_goTypes = []interface{}{
	(*JwtProvider)(nil),           // 0: envoy.extensions.filters.http.jwt_authn_author.v3.JwtProvider
	(*RemoteJwks)(nil),            // 1: envoy.extensions.filters.http.jwt_authn_author.v3.RemoteJwks
	(*RemoteAcl)(nil),             // 2: envoy.extensions.filters.http.jwt_authn_author.v3.RemoteAcl
	(*JwtHeader)(nil),             // 3: envoy.extensions.filters.http.jwt_authn_author.v3.JwtHeader
	(*ProviderWithAudiences)(nil), // 4: envoy.extensions.filters.http.jwt_authn_author.v3.ProviderWithAudiences
	(*JwtRequirement)(nil),        // 5: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement
	(*JwtRequirementOrList)(nil),  // 6: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirementOrList
	(*JwtRequirementAndList)(nil), // 7: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirementAndList
	(*RequirementRule)(nil),       // 8: envoy.extensions.filters.http.jwt_authn_author.v3.RequirementRule
	(*FilterStateRule)(nil),       // 9: envoy.extensions.filters.http.jwt_authn_author.v3.FilterStateRule
	(*JwtAuthentication)(nil),     // 10: envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication
	nil,                           // 11: envoy.extensions.filters.http.jwt_authn_author.v3.FilterStateRule.RequiresEntry
	nil,                           // 12: envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication.ProvidersEntry
	...
	(*v31.RouteMatch)(nil),        // 17: envoy.config.route.v3.RouteMatch
	(*v32.EtcdServiceConfig)(nil), // 18: envoy.config.etcd.v3.EtcdServiceConfig
}
var file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_depIdxs = []int32{
	1,  // 0: envoy.extensions.filters.http.jwt_authn_author.v3.JwtProvider.remote_jwks:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.RemoteJwks
	13, // 1: envoy.extensions.filters.http.jwt_authn_author.v3.JwtProvider.local_jwks:type_name -> envoy.config.core.v3.DataSource
	3,  // 2: envoy.extensions.filters.http.jwt_authn_author.v3.JwtProvider.from_headers:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.JwtHeader
	14, // 3: envoy.extensions.filters.http.jwt_authn_author.v3.RemoteJwks.http_uri:type_name -> envoy.config.core.v3.HttpUri
	15, // 4: envoy.extensions.filters.http.jwt_authn_author.v3.RemoteJwks.cache_duration:type_name -> google.protobuf.Duration
	14, // 5: envoy.extensions.filters.http.jwt_authn_author.v3.RemoteAcl.http_uri:type_name -> envoy.config.core.v3.HttpUri
	15, // 6: envoy.extensions.filters.http.jwt_authn_author.v3.RemoteAcl.cache_duration:type_name -> google.protobuf.Duration
	4,  // 7: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement.provider_and_audiences:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.ProviderWithAudiences
	6,  // 8: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement.requires_any:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirementOrList
	7,  // 9: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement.requires_all:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirementAndList
	16, // 10: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement.allow_missing_or_failed:type_name -> google.protobuf.Empty
	16, // 11: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement.allow_missing:type_name -> google.protobuf.Empty
	5,  // 12: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirementOrList.requirements:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement
	5,  // 13: envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirementAndList.requirements:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement
	17, // 14: envoy.extensions.filters.http.jwt_authn_author.v3.RequirementRule.match:type_name -> envoy.config.route.v3.RouteMatch
	5,  // 15: envoy.extensions.filters.http.jwt_authn_author.v3.RequirementRule.requires:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement
	11, // 16: envoy.extensions.filters.http.jwt_authn_author.v3.FilterStateRule.requires:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.FilterStateRule.RequiresEntry
	12, // 17: envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication.providers:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication.ProvidersEntry
	8,  // 18: envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication.rules:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.RequirementRule
	9,  // 19: envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication.filter_state_rules:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.FilterStateRule
	2,  // 20: envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication.remote_acl:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.RemoteAcl
	13, // 21: envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication.local_acl:type_name -> envoy.config.core.v3.DataSource
	18, // 22: envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication.etcd_service:type_name -> envoy.config.etcd.v3.EtcdServiceConfig
	5,  // 23: envoy.extensions.filters.http.jwt_authn_author.v3.FilterStateRule.RequiresEntry.value:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.JwtRequirement
	0,  // 24: envoy.extensions.filters.http.jwt_authn_author.v3.JwtAuthentication.ProvidersEntry.value:type_name -> envoy.extensions.filters.http.jwt_authn_author.v3.JwtProvider
...
func file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_msgTypes[5].OneofWrappers = []interface{}{
	...
	file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*JwtAuthentication_RemoteAcl)(nil),
		(*JwtAuthentication_LocalAcl)(nil),
	}
	type x struct{}
